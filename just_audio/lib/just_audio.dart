...
class AudioPlayer {
  ...
  Stream<VisualizerWaveformCapture> get visualizerWaveformStream => _visualizerWaveformSubject.stream;
  ...
  Future<void> startVisualizer({
    ...
    await (await _platform).startVisualizer(_startVisualizerRequest = StartVisualizerRequest(
        enableWaveform: enableWaveform, enableFft: enableFft, captureRate: captureRate, captureSize: captureSize));
  }
  ...
  Future<Duration?>? _setPlatformActive(bool active, {Completer<void>? playCompleter, bool force = false}) {
    ...
    void subscribeToEvents(AudioPlayerPlatform platform) {
      ...
      _visualizerFftSubscription =
          platform.visualizerFftStream.listen((message) => _visualizerFftSubject.add(VisualizerFftCapture(
                samplingRate: message.samplingRate,
...
class AndroidEqualizer extends AudioEffect with AndroidAudioEffect {
  ...
  Future<void> _activate() async {
    ...
    final response =
        await (await _player!._platform).androidEqualizerGetParameters(AndroidEqualizerGetParametersRequest());
